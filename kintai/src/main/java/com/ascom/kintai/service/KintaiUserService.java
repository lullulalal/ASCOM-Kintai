...
public class KintaiUserService {
	...
	public int taikinInsert(String workDate, String endTime, String restTime, String email) {
		int resultTaikin = 0;

		String new_endTime = workDate+" "+endTime;
		System.out.println(restTime);

		WorkappInfo workappinfo = new WorkappInfo(email, "", "", new_endTime, restTime, "", "");
	...
	public int shukinInsert(String workDate, String startTime, String email) {
		int resultShukin = 0;
		
		String new_startTime = workDate+" "+startTime;
	
		WorkappInfo workappinfo = new WorkappInfo(email, workDate, new_startTime, "", "", "", "");
