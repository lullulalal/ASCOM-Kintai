...
<body class="fixed-nav sticky-footer bg-dark" id="page-top" ng-app="ascomApp" ng-controller="comnCtrl">
  ...
  <input type="hidden" id="0007" value={{::getText('0007')}}>
  <input type="hidden" id="0042" value={{::getText('0042')}}>
  <input type="hidden" id="0021" value={{::getText('0021')}}>
  <input type="hidden" id="0043" value={{::getText('0043')}}>
  <input type="hidden" id="0045" value={{::getText('0045')}}>
  <input type="hidden" id="0044" value={{::getText('0044')}}>
