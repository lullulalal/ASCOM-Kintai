...
<body class="fixed-nav sticky-footer bg-dark" id="page-top" ng-app="ascomApp" ng-controller="comnCtrl">
  <!-- Navigation-->
  <div ng-controller="superAdminEmpMngCtrl">
  ...
  <div class="content-wrapper-white">
    ...
    <!-- menu -->
    <input type="hidden"  value={{::getText('0081')}}>
  	<input type="hidden"  value={{::getText('0034')}}>
	<input type="hidden"  value={{::getText('0035')}}>
	<input type="hidden"  value={{::getText('0080')}}>
	...
	<script src="./resources/angular/service/superAdmin_empManage_service.js"></script>
	<script src="./resources/angular/controller/superAdmin_empManage_controller.js"></script>
